...
### A Non-standard Analytics Career
...
- Battelle (started back when we called this **Statistics**)
- Huntington Bank

### R User

- Started with R in 2004 - I wish I had started sooner!
...
\item \texttt{ROxygen} and \texttt{RUnit} for fuction decoration and unit testing
...
\item R arrays are 1-based in the intepreter, 0-based in the underlying \texttt{C} code. 
\begin{itemize}
...
**Other R Code**:  <https://r-forge.r-project.org/users/bertcarnell/>
